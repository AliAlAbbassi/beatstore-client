import docx, { Paragraph, TextRun, Packer, Document } from 'docx'
import { saveAs } from 'file-saver'
import React, { useState } from 'react'
import { connect } from 'react-redux'

const GetWavTrackoutLease = () => {
    ...
    doc.addSection({
        ...
        children: [
            new Paragraph({
                text: `This Non-Exclusive WAV Trackouts Lease License Agreement (the “Agreement”), having been made on and effective as of ${fullDate} (the “Effective Date”) by and between Producer Name p/k/a Cuthlehoop (the “Producer” or “Licensor”); and Licensee residing at ${name || auth.user.data.name} (“You” or “Licensee”), sets forth the terms and conditions of the Licensee’s use, and the rights granted in, the Producer’s instrumental music file entitled The Beat Title (Contract Preview Only) (the “Beat”) in consideration for Licensee’s payment of $75 (the “License Fee”), on a so-called “WAV Trackouts Lease” basis.
...
`,
            ...
            new Paragraph({
                text: `For the avoidance of doubt, you do not own the master or the sound recording rights in the New Song. You have been licensed the right to use the Beat in the New Song and to commercially exploit the New Song based on the terms and conditions of this Agreement.
`,
                bullet: {
                    level: 1
                }
            ...
            new Paragraph({
                text: `Notwithstanding the above, you do own the lyrics or other original musical components of the New Song that were written or composed solely by you.
`,
                bullet: {
                    level: 2
                }
            ...
            new Paragraph({
                text: `With respect to the publishing rights and ownership of the underlying composition embodied in the New Song, the Licensee, and the Producer hereby acknowledge and agree that the underlying composition shall be owned/split between them as follows:
...
`,
            ...
            new Paragraph({
                text: `Producer shall own, control, and administer One Hundred Percent (100%) of the so-called “Publisher’s Share” of the underlying composition.
`,
                bullet: {
                    level: 2
                }
...
`,
            ...
            new Paragraph({
                text: `The licensee shall be deemed to have signed, affirmed and ratified its acceptance of the terms of this Agreement by virtue of its payment of the License Fee to Licensor and its electronic acceptance of its terms and conditions at the time Licensee made payment of the License Fee.
`,
                bullet: {
                    level: 1
                }
...
`,
            ...
            new Paragraph({
                text: `Warranties, Representations, and Indemnification:
`,
                bullet: {
                    level: 0
                }
...
`,
    ...
    Packer.toBlob(doc).then((blob) => {
        ...
        saveAs(blob, "WavTrackoutsLeaseLicenseAgreement.docx");
    });
}
...
export default connect(mapStateToProps, {})(GetWavTrackoutLease)