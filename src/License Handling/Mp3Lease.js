...
const GetMp3Lease = ({ auth }) => {
    ...
    doc.addSection({
        ...
        children: [
            new Paragraph({
                text:
                    `This Non-Exclusive MP3 Lease License Agreement (the “Agreement”), having been made on and effective as of ${fullDate} (the “Effective Date”) by and between Producer Name p/k/a Cuthlehoop (the “Producer” or “Licensor”); and Licensee residing at ${name || auth.user.data.name} (“You” or “Licensee”), sets forth the terms and conditions of the Licensee’s use, and the rights granted in, the Producer’s instrumental music file entitled The Beat Title (Contract Preview Only) (the “Beat”) in consideration for Licensee’s payment of $20 (the “License Fee”), on a so-called “MP3 Lease” basis.
...
`
            ...
            new Paragraph({
                text: `Licensor agrees to deliver the Beat as a high-quality MP3, as such terms are understood in the music industry.`,
                bullet: {
                    level: 1
                }
            }),
            new Paragraph({
                text: `Licensor shall use commercially reasonable efforts to deliver the Beat to Licensee immediately after payment of the License Fee is made. Licensee will receive the Beat via email, to the email address Licensee provided to the Licensor.`,
                bullet: {
                    level: 1
                }
            }),
            ...
            new Paragraph({
                text: `- Licensee, owns 50% of the writers share.
...
`,
    ...
    Packer.toBlob(doc).then((blob) => {
        ...
        saveAs(blob, "Mp3LeaseLicenseAgreement.docx");
    });
}
