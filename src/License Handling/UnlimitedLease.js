...
const GetUnlimitedLease = () => {
    ...
    doc.addSection({
        ...
        children: [
            new Paragraph({
                text: `This Non-Exclusive Unlimited Lease License Agreement (the “Agreement”), having been made on and effective as of ${fulldate} (the “Effective Date”) by and between Producer Name p/k/a Cuthlehoop (the “Producer” or “Licensor”); and Licensee residing at ${name || auth.user.data.name} (“You” or “Licensee”), sets forth the terms and conditions of the Licensee’s use, and the rights granted in, the Producer’s instrumental music file entitled The Beat Title (Contract Preview Only) (the “Beat”) in consideration for Licensee’s payment of $100 (the “License Fee”), on a so-called “Unlimited Lease” basis.
...
`,
            ...
            new Paragraph({
                text: `The Licensee may use the New Song in synchronization with Unlimited (Unlimited) audiovisual work no longer than five (5) minutes in length (a “Video”). In the event that the New Song itself is longer than five (5) minutes in length, the Video may not play for longer than the length of the New Song. The Video may be broadcast on any television network and/or uploaded to the internet for digital streaming and/or free download by the public including but not limited to on YouTube and/or Vevo. Producer grants no other synchronization rights to Licensee;
`,
                bullet: {
                    level: 2
                }
...
`,
    ...
    Packer.toBlob(doc).then((blob) => {
        ...
        saveAs(blob, "UnlimitedLeaseLicenseAgreement.docx");
    });
}
...
export default connect(mapStateToProps, {})(GetUnlimitedLease)